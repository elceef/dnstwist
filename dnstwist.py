...
class DomainFuzz():
	...
	def __homoglyph(self):
		...
		'c': [u'ϲ', u'с', u'ⅽ', u'ƈ', u'ċ', u'ć'],
		'd': ['b', 'cl', 'dl', 'di', u'ԁ', u'ժ', u'ⅾ', u'ｄ', u'ɗ'],
		'e': [u'é', u'ê', u'ë', u'ē', u'ĕ', u'ė', u'ｅ', u'е', u'ẹ', u'ę'],
		'f': [u'Ϝ', u'Ｆ', u'ｆ'],
		'g': ['q', u'ɢ', u'ɡ', u'Ԍ', u'Ԍ', u'ｇ', u'ġ'],
		'h': ['lh', 'ih', u'һ', u'ｈ'],
		'i': ['1', 'l', u'Ꭵ', u'ⅰ', u'ｉ', u'í', u'ï'],
		'j': [u'ј', u'ｊ', u'ʝ'],
		'k': ['lk', 'ik', 'lc', u'κ', u'ｋ'],
		'l': ['1', 'i', u'ⅼ', u'ｌ'],
		'm': ['n', 'nn', 'rn', 'rr', u'ṃ', u'ⅿ', u'ｍ'],
		'n': ['m', 'r', u'ｎ', u'ń'],
		'o': ['0', u'Ο', u'ο', u'О', u'о', u'Օ', u'Ｏ', u'ｏ', u'ȯ', u'ọ', u'ỏ', u'ơ', u'ó'],
		'p': [u'ρ', u'р', u'ｐ'],
		'q': ['g', u'ｑ', u'զ'],
		'r': [u'ʀ', u'ｒ'],
		's': [u'Ⴝ', u'Ꮪ', u'Ｓ', u'ｓ', u'ʂ', u'ś'],
		't': [u'τ', u'ｔ'],
		'u': [u'μ', u'υ', u'Ս', u'Ｕ', u'ｕ', u'ս'],
		'v': [u'ｖ', u'ѵ', u'ⅴ', u'ν'],
		'w': ['vv', u'ѡ', u'ｗ'],
		'x': [u'ⅹ', u'ｘ', u'х', u'ҳ'],
		'y': [u'ʏ', u'γ', u'у', u'Ү', u'ｙ', u'ý'],
		'z': [u'ｚ', u'ʐ', u'ż', u'ź', u'ʐ']
		}
